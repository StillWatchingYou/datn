...
//		SSD1306_Puts((char *)numberToString(hrtc1.date_time.second), &Font_7x10, SSD1306_COLOR_WHITE); 
		...
		SSD1306_Puts((char *)numberToString(DHT11.Temp), &Font_7x10, SSD1306_COLOR_WHITE); 
    SSD1306_Puts ("*C", &Font_7x10, 1);	 
		SSD1306_GotoXY (1,50); 
		SSD1306_Puts ("Humi:", &Font_7x10, 1); 
		SSD1306_Puts((char *)numberToString(DHT11.Humi), &Font_7x10, SSD1306_COLOR_WHITE); 
    SSD1306_Puts ("%", &Font_7x10, 1);
		SSD1306_Puts("             ", &Font_7x10, SSD1306_COLOR_WHITE);
}  
		if (gas_change == 1) {
...
void menuShow() {
    ...
    SSD1306_GotoXY (1,10); // goto 10, 10 	
		...
		SSD1306_GotoXY (1,20); // goto 10, 10 
